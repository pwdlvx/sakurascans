...
const defaultComics: Comic[] = [
  {
    ...
    chapters: [
      { id: "ch-167", comicId: "popular-1", number: "167", title: "The Final Battle", pages: ["https://pub-147c0e6473734b4eb154dc1c7a97ebc1.r2.dev/02-optimized.webp"], publishedAt: new Date('2025-07-14T22:00:00Z') },
      { id: "ch-166", comicId: "popular-1", number: "166", title: "Preparation", pages: [], publishedAt: new Date('2025-07-13T00:00:00Z') },
      { id: "ch-165", comicId: "popular-1", number: "165", title: "Training", pages: [], publishedAt: new Date('2025-07-10T00:00:00Z') }
    ],
    rating: 9.9,
    views: 150000,
  ...
  },
  {
    ...
    chapters: [
      { id: "ch-109", comicId: "popular-2", number: "109", title: "New Techniques", pages: [], publishedAt: new Date('2025-07-14T18:00:00Z') },
      { id: "ch-108", comicId: "popular-2", number: "108", title: "Academy Festival", pages: [], publishedAt: new Date('2025-07-12T00:00:00Z') },
      { id: "ch-107", comicId: "popular-2", number: "107", title: "Sword Master's Path", pages: [], publishedAt: new Date('2025-07-09T00:00:00Z') }
    ],
    rating: 9.5,
    views: 120000,
  ...
  },
  {
    ...
    chapters: [
      { id: "ch-15", comicId: "featured-1", number: "15", title: "The Prophecy Unfolds", pages: ["https://pub-147c0e6473734b4eb154dc1c7a97ebc1.r2.dev/02-optimized.webp", "https://picsum.photos/800/1200?random=1", "https://picsum.photos/800/1200?random=2"], publishedAt: new Date('2025-07-14T23:30:00Z') },
      { id: "ch-14", comicId: "featured-1", number: "14", title: "Empire's Secrets", pages: [], publishedAt: new Date('2025-07-14T00:00:00Z') },
      { id: "ch-13", comicId: "featured-1", number: "13", title: "Noble Houses", pages: [], publishedAt: new Date('2025-07-11T00:00:00Z') }
    ],
    rating: 9.3,
    views: 200000,
  ...
  },
  {
    ...
    chapters: [
      { id: "ch-120", comicId: "action-1", number: "120", title: "Divine Power Awakens", pages: [], publishedAt: new Date('2025-07-14T23:00:00Z') },
      { id: "ch-119", comicId: "action-1", number: "119", title: "Knight's Return", pages: [], publishedAt: new Date('2025-07-13T12:00:00Z') },
      { id: "ch-118", comicId: "action-1", number: "118", title: "Gods' Blessing", pages: [], publishedAt: new Date('2025-07-08T00:00:00Z') }
    ],
    rating: 9.7,
    views: 180000,
  ...
  },
  {
    ...
    chapters: [
      { id: "ch-43", comicId: "magic-1", number: "43", title: "Land's Destruction", pages: [], publishedAt: new Date('2025-07-14T21:00:00Z') },
      { id: "ch-42", comicId: "magic-1", number: "42", title: "Magical Powers", pages: [], publishedAt: new Date('2025-07-12T12:00:00Z') },
      { id: "ch-41", comicId: "magic-1", number: "41", title: "World Reshape", pages: [], publishedAt: new Date('2025-07-07T00:00:00Z') }
    ],
    rating: 9.4,
    views: 160000,
...
export function ComicsProvider({ children }: { children: React.ReactNode }) {
  const [comics, setComics] = useState<Comic[]>(defaultComics);

  useEffect(() => {
    // Load comics from localStorage in browser only
    ...
    if (dataVersion !== '2.0' || !savedComics) {
      ...
      localStorage.setItem('sakura-comics', JSON.stringify(defaultComics));
    } else {
      try {
        const parsedComics = JSON.parse(savedComics).map((comic: any) => ({
          ...comic,
  ...
  const latestUpdates = comics
    ...
    .map(comic => {
      const sortedChapters = [...comic.chapters].sort((a, b) => b.publishedAt.getTime() - a.publishedAt.getTime());
